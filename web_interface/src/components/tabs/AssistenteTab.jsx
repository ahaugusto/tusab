      ...
      <AnimatePresence mode="wait">
        ...
        {subTab === 'configuracoes' && (
          <motion.div key="configuracoes"
            ...
            {/* Toggle "Mostrar raciocínio" foi movido pra dentro dos cards dos
                modelos com thinking nativo em OllamaSetup.jsx — é onde faz
                sentido controlar algo que só tem efeito em modelos específicos,
                em vez de uma seção avulsa aqui sem relação visual com eles. */}
